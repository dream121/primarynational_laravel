...
MarkerClusterer.prototype.createClusters_ = function() {
  ...
  if (this.ready_)
    for (var a, b = new google.maps.LatLngBounds(this.map_.getBounds().getSouthWest(), this.map_.getBounds().getNorthEast()), c = this.getExtendedBounds(b), d = 0; a = this.markers_[d]; d++) !a.isAdded && this.isMarkerInBounds_(a, c) && this.addToClosestCluster_(a)
};
MarkerClusterer.prototype.distanceBetweenPoints_ = function(a, b) {
 ...
 MarkerClusterer.prototype.addToClosestCluster_ = function(a) {
        var b = 4e4,
            c = null;
        a.getPosition();
        for (var d, e = 0; d = this.clusters_[e]; e++) {
            var f = d.getCenter();
            if (f) {
