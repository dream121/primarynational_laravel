...
//    });
    ...
    $(document).ready(function(){
        ...
        $("#min_price").change(function(e){
            location.replace('/search?min_price='+$(this).val());
        });
        $("#max_price").change(function(e){
            location.replace('/search?max_price='+$(this).val());
        });
        $(".beds").click(function(e){
            location.replace('/search?beds='+$(this).val());
        });
        $(".baths").click(function(e){
            location.replace('/search?baths='+$(this).val());
        });
        ...
        var types='';
            ...
            location.replace('/search?types='+types);
        });
...
//                        search_query.features.push($(this).val());
            ...
            $('.more_options').show();
            $(".more").slideToggle(1);
            location.replace('/search?'+$.param(search_query));
...
<div class="container-fluid max_width bg_white">
    <div class="sub_menu">
        <div class="col-md-3 visible-md visible-sm visible-lg">
            <div class="logo_2">
                <a href="{{url('/')}}"><img src="{{asset('assets/img/logo.jpg')}}" alt="Sub Logo"/></a>
            </div>
        </div>
                    ...
                    <form class="clearfix">
                        ...
                        <div class="search_2_details">
                            ...
                            <div class="btn-group sub-search">
                                ...
                                <button type="button" id="price_drop_down" class="btn btn-danger btn-lg">Price <span class="caret"></span></button>
                                ...
                                <div class="dropdown-menu types_drop drop2" role="menu" aria-labelledby="types_drop">
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option1" value="any">
                                                            Any
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option2" value="SF"
                                                                   >
                                                            Single Familly
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option3" value="condo"
                                                                   >
                                                            condo
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option4" value="land"
                                                                   >
                                                            land
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option5" value="mf">
                                                            MF
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option6" value="com">
                                                            com
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input class="types_option" type="checkbox" name="types_option7" value="rent">
                                                            rent
                                                        </label>
                                                    </div>
                                ...
                                <div class="btn-group">
                                    <div aria-labelledby="baths_drop" role="menu" class="dropdown-menu drop2 baths_drop">
                                                   <div class="radio">
                                                        <label>
                                                            <input class="baths" type="radio" value="any" name="optionsRadios">
                                                            Any
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input class="baths" type="radio" value="2" name="optionsRadios">
                                                            2+
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input class="baths" type="radio" value="3" name="optionsRadios">
                                                            3+
                                                        </label>
                                                    </div>
                                                    <div class="radio">                                                        <label>
                                                            <input class="baths" type="radio"  cvalue="4" name="optionsRadios">
                                                            4+
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
                                                            <input class="baths" type="radio"  value="5" name="optionsRadios">
                                                            5+
                                                        </label>
                                                    </div>
