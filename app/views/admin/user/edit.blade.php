...
<div class="row">
	<div class="col-lg-12 clearfix">
		<h1 class="page-header">{{$page_title}} <a class="btn btn-small btn-success pull-right" href="{{ URL::to('admin/user') }}"><span class="glyphicon glyphicon-chevron-left"></span> Back to Agent list</a></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
            ...
            <div class="form-group" >
                {{ Form::label('Agent ID : ') }}
                {{ Form::text('agent_id',$agent->agent_id,array('class'=>'form-control','id'=>'agent_id')) }}
				...
				<div class="form-group">
					...
					{{ Form::text('office_name',@$agent->profile->office_name,array('class'=>'form-control','id'=>'phone')) }}
				...
				<div class="form-group">
					...
					<img src="{{url($agent->profile->photo)}}" > <br>
					@endif
