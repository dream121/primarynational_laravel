        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group" >
                    {{ Form::hidden('id',$buy->id)}}
                    {{ Form::label('Title : ') }}
                    {{ Form::text('title',$buy->title,array('id'=>'title','class'=>'form-control')) }}
                    {{ $errors->first('title','<p class="text-red">:message</p>'); }}

                </div>
                <div class="form-group">
                    {{ Form::label('Content : ') }}
                    {{ Form::textarea('content',$buy->content,array('class'=>'form-control','id'=>'summernote')) }}
