...
<div class="row">
	<div class="col-lg-12 clearfix">
		<h1 class="page-header">{{$page_title}} <a class="btn btn-small btn-success pull-right" href="{{ URL::to('admin/agent') }}"><span class="glyphicon glyphicon-chevron-left"></span> Back to Agent list</a></h1>
	</div>
</div>
